...
import { b as createLucideIcon, d as useQueryClient, u as useNavigate, a as useLanguage, f as useParams, r as reactExports, j as jsxRuntimeExports, X, m as motion, S as Skeleton, e as ue, _ as __vitePreload } from "./index-BtujrhLu.js";
import { L as Layout, i as isVerifiedUser, o as isOwnerProfile, V as VerificationBadge, U as Users, G as Globe } from "./Layout-BEZURZ7z.js";
...
import { u as useCurrentUser, a as useAuthenticatedBackend, c as useMutation, b as useQuery, V as Visibility, d as ReactionType } from "./index-Cu1SjqX8.js";
...
import { B as Bookmark, P as Pin, C as ChevronUp, a as ChevronDown } from "./pin-BhB_7725.js";
...
function SessionExpired() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-amber-500/10 border border-amber-500/20 flex items-center justify-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { className: "w-7 h-7 text-amber-400" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xl font-semibold text-foreground mb-2", children: "Session expirée" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-6 max-w-xs leading-relaxed", children: "Votre session a expiré. Veuillez vous reconnecter pour accéder à votre profil." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
...
function ProfilePage() {
  ...
  if (!userId || profileError || userProfile === null || userProfile === void 0) {
    if (isOwnProfile || status === "authenticated" && !userId) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SessionExpired, {}) });
    }
